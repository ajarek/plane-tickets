import { createCity} from "./airports.js"
import {distanceAirPort} from "./airports.js"
import {displayKod} from "./airports.js"
import {getRandom} from "./user.js"
    ...
    startTime.addEventListener('change',()=>{
        ...
        if(km.innerHTML!=''){
            airSelect.forEach(air=>{
             if(air.value =='Lot'){speed=700}
             if(air.value =='Ryanair'){speed=800}
             if(air.value =='Lufthansa'){speed=900}
             if(air.value =='Air France'){speed=1000}
             if(air.value =='Areoflot'){speed=1100}
